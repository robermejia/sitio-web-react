  ...
  const portfolioItems = [
    {
      category: 'react',
      title: 'Idea Manager',
      thumb: '/img/portfolio/thumb/project-18.png',
      screenshots: [
        '/img/portfolio/large/project-18/1.png',
        '/img/portfolio/large/project-18/2.png',
        '/img/portfolio/large/project-18/3.png',
        '/img/portfolio/large/project-18/4.png',
        '/img/portfolio/large/project-18/5.png'
      ],
      description: 'Plataforma para gestionar y organizar ideas, utilizando React, Firebase y Render para su despliegue.',
      date: '2026',
      client: 'Proyecto Personal',
      tools: 'React JS, Render, Firebase',
      link: 'https://ideamanager-vbzv.onrender.com/'
    },
    {
      category: 'react',
      title: 'Terapia TCC',
      ...
      screenshots: [
        '/img/portfolio/large/project-17/1.png',
        '/img/portfolio/large/project-17/2.png',
        '/img/portfolio/large/project-17/3.png',
        '/img/portfolio/large/project-17/4.png',
        '/img/portfolio/large/project-17/5.png',
        '/img/portfolio/large/project-17/6.png',
        '/img/portfolio/large/project-17/7.png',
        '/img/portfolio/large/project-17/8.png',
        '/img/portfolio/large/project-17/9.png',
        '/img/portfolio/large/project-17/10.png',
        '/img/portfolio/large/project-17/11.png',
        '/img/portfolio/large/project-17/12.png',
        '/img/portfolio/large/project-17/13.png',
        '/img/portfolio/large/project-17/14.png',
        '/img/portfolio/large/project-17/15.png',
        '/img/portfolio/large/project-17/16.png',
        '/img/portfolio/large/project-17/17.png',
        '/img/portfolio/large/project-17/18.png',
        '/img/portfolio/large/project-17/19.png',
        '/img/portfolio/large/project-17/20.png',
        '/img/portfolio/large/project-17/21.png',
        '/img/portfolio/large/project-17/22.png'
      ],
    ...
    },
    {
      ...
      screenshots: [
        '/img/portfolio/large/project-16/1.png',
        '/img/portfolio/large/project-16/2.png',
        '/img/portfolio/large/project-16/3.png',
        '/img/portfolio/large/project-16/4.png',
        '/img/portfolio/large/project-16/5.png',
        '/img/portfolio/large/project-16/6.png',
        '/img/portfolio/large/project-16/7.png',
        '/img/portfolio/large/project-16/8.png',
        '/img/portfolio/large/project-16/9.png',
        '/img/portfolio/large/project-16/10.png',
        '/img/portfolio/large/project-16/11.png',
        '/img/portfolio/large/project-16/12.png'
      ],
    ...
    },
    {
      ...
      screenshots: [
        '/img/portfolio/large/project-15/1.png',
        '/img/portfolio/large/project-15/2.png',
        '/img/portfolio/large/project-15/3.png',
        '/img/portfolio/large/project-15/4.png',
        '/img/portfolio/large/project-15/5.png',
        '/img/portfolio/large/project-15/6.png',
        '/img/portfolio/large/project-15/7.png',
        '/img/portfolio/large/project-15/8.png',
        '/img/portfolio/large/project-15/9.png'
      ],
    ...
    },
    {
      ...
      screenshots: [
        '/img/portfolio/large/project-14/1.png',
        '/img/portfolio/large/project-14/2.png',
        '/img/portfolio/large/project-14/3.png'
      ],
    ...
    {
      category: 'react',
      title: 'Manual de Programación',
      thumb: '/img/portfolio/thumb/project-13.png',
      screenshots: [
        '/img/portfolio/large/project-13/1.png',
        '/img/portfolio/large/project-13/2.png',
        '/img/portfolio/large/project-13/3.png',
        '/img/portfolio/large/project-13/4.png',
        '/img/portfolio/large/project-13/5.png',
        '/img/portfolio/large/project-13/6.png'
      ],
    ...
    },
    {
      ...
      screenshots: [
        '/img/portfolio/large/project-12/1.png',
        '/img/portfolio/large/project-12/2.png',
        '/img/portfolio/large/project-12/3.png',
        '/img/portfolio/large/project-12/4.png',
        '/img/portfolio/large/project-12/5.png',
        '/img/portfolio/large/project-12/6.png'
      ],
